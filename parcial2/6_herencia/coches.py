...
class Camiones(Coche):
    ...
    def get_info(self):
        return f"Marca: {self.marca}, Color: {self.color}, Modelo: {self.modelo}, Velocidad: {self.velocidad}, Caballaje: {self.caballaje}, Plazas: {self.plazas}, Eje: {self.__eje}, Capadidad de carga: {self.__capacidadCarga}"    
...
class Camionetas(Coche):
    ...
    def get_info(self):
        return f"Marca: {self.marca}, Color: {self.color}, Modelo: {self.modelo}, Velocidad: {self.velocidad}, Caballaje: {self.caballaje}, Plazas: {self.plazas}, Traccion: {self.traccion}, Cerrada: {self.cerrada}"        