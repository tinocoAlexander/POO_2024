...
while True:
    ...
    if opcion == "1":
        ...
        nombre_viejo = input("Teclea el nombre de la pelicula que quieres actualizar: ")
        nombre_nuevo = input("Teclea el nuevo nombre de la pelicula: ")
        funciones.actualizar_pelicula(lista_peliculas, nombre_viejo, nombre_nuevo)
    elif opcion == "5":
        nombre = input("Teclea el nombre de la pelicula que quieres buscar: ")
        funciones.buscar_pelicula(lista_peliculas, nombre)
    elif opcion == "6":
        confirmar = input("¿Estás seguro de que deseas vaciar la lista de películas? (s/n): ")
        if confirmar.lower() == 's':
            funciones.vaciar_lista(lista_peliculas)
    elif opcion == "7":
        print("Bye bye")
        break
    else:
